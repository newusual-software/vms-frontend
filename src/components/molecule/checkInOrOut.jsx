...
export default function StaffCheckInOrOut() {
  ...
  function closeModal() {
    setIsOpen(false) || setIsOpenQ(false) || setIsOpenY(false) || setIsOpenZ(false);
  }
                ...
                >
                  <Dialog.Panel className="w-full max-w-3xl h-[25rem] transform overflow-y-hidden rounded-2xl flex flex-col justify-center  bg-white px-12 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="mt-2 flex flex-col justify-center items-center w-full ">
                      <div className="w-[60%]">
                        <h1 className="font-dmSans font-bold text-center text-2xl pt-14 ">Check in Visitor</h1>
                        <h3 className='font-dmSans text-[#BDBDBD] text-center text-md font-bold pb-6 pt-3'>You are requird to check in the vistor MD2041A/291 for the 30 min visit</h3>
                      </div>
                      <div className="grid grid-cols-2 w-full">
                        {userDetails.map((userDetail) => {
                          return (
                            <div key={userDetail.title} className="w-full gap-4 font-dmSans flex items-center">
                              ...
                              <div className=" text-left flex-nowrap ">
                                <h3 className=" py-2 ">{userDetail?.value} <span className='font-bold'>{ !undefined && (`${userDetail?.valueExtra}`) }</span></h3>
                              </div>
                    ...
                    <div className="flex gap-3 pb-5 justify-end items-center">
                      <div className='font-dmSans text-[#828282] font-normal '>Current time</div>
                      <div className="text-lg text-[#EB5757]">
                        {hour < 10 ? `0${hour}` : hour}:{minute < 10 ? `0${minute}` : minute} WAT
                      </div>
                      <button onClick={handleSubmit} className="w-[6rem] text-white py-2 outline-none rounded-lg bg-[#4F4F4F]">
                        Check in
                      </button>
                    </div>
              ...
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                ...
                >
                  <Dialog.Panel className="w-full max-w-3xl h-[25rem] transform overflow-y-hidden rounded-2xl flex flex-col justify-center  bg-white px-12 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="mt-2 flex flex-col justify-center items-center w-full ">
                      <div className="w-[60%]">
                        <h1 className="font-dmSans font-bold text-center text-2xl pt-14 ">Check Out Visitor</h1>
                        <h3 className='font-dmSans text-[#BDBDBD] text-center text-md font-bold pb-6 pt-3'>You are requird to check in the vistor MD2041A/291 for the 30 min visit</h3>
                      </div>
                      <div className="grid grid-cols-2 w-full">
                        {userDetails.map((userDetail) => {
                    ...
                    <div className="flex gap-3 pb-5 justify-end items-center">
                      ...
                      <button onClick={handleQcheck} className="w-[6rem] text-white py-2 outline-none rounded-lg bg-[#4F4F4F]">
                        Check Out
                      </button>
                    </div>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left flex flex-col justify-center items-center align-middle shadow-xl transition-all">
                  ...
                  >
                    Do you want to check in Adewunmi DANGO?
                  </Dialog.Title>
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left flex flex-col justify-center items-center align-middle shadow-xl transition-all">
                  ...
                  <Dialog.Title
                    ...
                    className="text-lg text-[#333333] font-lato  font-bold leading-6"
                  >
                    Visitor Adewunmi DANGO, checked Out!
                  </Dialog.Title>
        ...
        <div className='flex gap-14 justify-center items-center flex-col md:flex-row w-full'>
          ...
          <div className='w-1/2 flex justify-center items-center cursor-pointer' onClick={handleClick}>
            <div className="py-8 px-14 w-full md:h-[8rem] mx-auto bg-white rounded-xl shadow filter drop-shadow-lg space-y-6 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
              <img className="block w-10" src="https://res.cloudinary.com/phantom1245/image/upload/v1680970978/nem-insurance/coolion_tcag0k.png" alt=""/>
          ...
          <div className='w-1/2 flex justify-start cursor-pointer items-center' onClick={handleCheckout}>
            <div className="py-8 px-14 w-full md:h-[8rem]  bg-white rounded-xl shadow filter drop-shadow-lg space-y-6 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
              <img className="block w-10" src="https://res.cloudinary.com/phantom1245/image/upload/v1680971453/nem-insurance/coolicon_to1ogv.png" alt="Woman's Face"/>
              <div className="text-center space-y-2 sm:text-left">
